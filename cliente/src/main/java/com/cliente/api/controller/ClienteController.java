...
public class ClienteController {
	...
	public ResponseEntity<?> guardarCliente(@Valid @RequestBody Cliente clientes, BindingResult result){
		Cliente clientesObj = null;
		...
		try {
			clientesObj = service.save(clientes);
		...
		response.put("cliente", clientesObj);
	...
	public ResponseEntity<?> eliminar(@PathVariable Long id){
		...
		response.put("mensaje", "Cliento eliminada con exito.");
